...
\vspace*{1.5cm}
\fontsize{18}{1}\selectfont \textbf{ÁP DỤNG THUẬT TOÁN HỌC TĂNG CƯỜNG DỰ
ĐOÁN LIỀU DÙNG WARFARIN TỐI ƯU VỚI DỮ LIỆU LÂM SÀNG VÀ CÁC GEN DƯỢC} \\
\vspace{2cm}
...
\begin{tabular}{ll}
Người hướng dẫn:  & PGS.TS Nguyễn Thị Hồng Minh \\   & ThS. NCS. Tạ Văn
Nhân
\end{tabular}
}}
\\
...
{\fontsize{18}{1}\selectfont \textbf{ÁP DỤNG THUẬT TOÁN HỌC TĂNG CƯỜNG
